...
var text = svgContainer.append('text')
      ...
      .attr ('fill', 'black');
            ...
            //logica do computador 1
                  @if(empty($sociais_mesa4_equipamento1->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 2
                  @if(empty($sociais_mesa4_equipamento2->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 3
                  @if(empty($sociais_mesa4_equipamento3->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 4
                  @if(empty($sociais_mesa4_equipamento4->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 5
                  @if(empty($sociais_mesa4_equipamento5->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 6
                  @if(empty($sociais_mesa4_equipamento6->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 7
                  @if(empty($sociais_mesa4_equipamento7->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 8
                  @if(empty($sociais_mesa4_equipamento8->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
