...
var text = svgContainer.append('text')
      ...
      .attr ('fill', 'black');
            ...
            //logica do computador 1
                  @if(empty($sociais_mesa5_equipamento1->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 2
                  @if(empty($sociais_mesa5_equipamento2->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 3
                  @if(empty($sociais_mesa5_equipamento3->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
            ...
            //logica do computador 4
                  @if(empty($sociais_mesa5_equipamento4->username))
                        .attr('fill', 'red');
                  @else
                        .attr('fill', 'green');
                  @endif
